...
data_root = 'E:/datasets/VisDrone2019-DET-COCO/'
...
test_evaluator = dict(
    ann_file=
    'E:/datasets/VisDrone2019-DET-COCO/annotations/VisDrone2019-DET_val_coco.json',
    metric='bbox',
    proposal_nums=(
        100,
        1,
...
val_ann_file = 'annotations/VisDrone2019-DET_val_coco.json'
val_batch_size_per_gpu = 2
val_cfg = dict(type='ValLoop')
val_data_prefix = 'val2019/'
val_dataloader = dict(
    batch_size=2,
    dataset=dict(
        ann_file='annotations/VisDrone2019-DET_val_coco.json',
...
weight_decay = 0.0005
widen_factor = 0.25
work_dir = './output_dir/remnet_n_visdrone'
